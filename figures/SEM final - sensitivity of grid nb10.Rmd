...
Results are obtained with Rpackage Lavaan. Not all grid cells had data in all time periods. In the main analysis, we removed all ecoregions/subdivisions with fewer than 6 grid cells with observations. Here, we exclude all data with fewer than 10 grid cells with observations
...
write.csv(SEM_out,file="C:/Users/danie/Documents/Online for git/DemFish_trawl/figures/SEM_out_grid10.csv")
